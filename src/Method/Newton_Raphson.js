...
import Newton_Raphson_Graph from '../components/Newton_Raphson_Graph';
...
import { compile, abs, round, derivative } from 'mathjs';
...
export default function Newton_Raphson() {
    ...
    function componentDidMount() {
        ...
        axios.get('http://localhost:8000/data/Newton_Raphson').then(res => {
            api = res.data;
    ...
    const handleSubmit = (e) => {
        ...
        fxx = compile(fx).evaluate({ x: x0 });
        dfx = derivative(fx, 'x').evaluate({ x: x0 });
        ...
        <div>
            ...
            <Layout style={{ marginTop: 64 }}>
                ...
                <Layout>
                    <Content id="content">
                        <div id="c1">
                            <h1 style={{ textAlign: 'center', paddingBottom: '20px', margin: 0 }}>Newton-Raphson Method</h1>
                            <div style={{ display: 'flex' }}>
                                <form id="Form" onSubmit={handleSubmit}>
                                    ...
                                    <br /><br />
                                    <Input id="start" addonBefore="X" size='small' placeholder="input X" style={{ width: 300 }} value={start} onChange={(e) => setStart(e.target.value)} />
                                    <br /><br /><br />
                                ...
                                <div id='Graph'>
                                    {
                                        isSubmit &&
                                        <Newton_Raphson_Graph fx={fx} start={start} error={arr4} />
                                    }
                                </div>
                            </div>
