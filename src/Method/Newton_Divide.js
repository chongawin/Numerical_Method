...
import Newton_Divide_Graph from '../components/Newton_Divide_Graph';
...
export default function Newton_Divide() {
                ...
                <Layout>
                    <Content id="content">
                        <div id="c1" onSubmit={handleSubmit}>
                            <h1 style={{ textAlign: 'center', paddingBottom: '20px', margin: 0 }}>Newton's divided-differences Method</h1>
