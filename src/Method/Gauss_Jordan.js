...
function Gauss_Jordan() {
    ...
    function componentDidMount() {
        ...
        axios.get('http://localhost:8000/data/Gauss_Jordan').then(res => {
            api = res.data;
    ...
    const handleSubmit = (e) => {
        ...
        let A10 = [
            [x11 / x11, x21 / x11, x31 / x11, ans1 / x11],
            [A8[1][0] / A8[1][1], A8[1][1] / A8[1][1], A8[1][2] / A8[1][1], A8[1][3] / A8[1][1]],
            [A8[2][0] / A8[2][2], A8[2][1] / A8[2][2], A8[2][2] / A8[2][2], A8[2][3] / A8[2][2]]
        ];
        console.log(A10)

        //Step 1 of Jordan
        let A11 = [
            [A10[0][0], A10[0][1], A10[0][2], A10[0][3]],
            [A10[1][0], A10[1][1], A10[1][2], A10[1][3]],
            [A10[2][0] * A10[1][2], A10[2][1] * A10[1][2], A10[2][2] * A10[1][2], A10[2][3] * A10[1][2]]
        ];
        console.log(A11)

        if (A11[1][2] - A11[2][2] != 0) {
            let A12 = [
                [A11[0][0], A11[0][1], A11[0][2], A11[0][3]],
                [A11[1][0] + A11[2][0], A11[1][1] + A11[2][1], A11[1][2] + A11[2][2], A11[1][3] + A11[2][3]],
                [A10[2][0], A10[2][1], A10[2][2], A10[2][3]]
            ];
            console.log(A12)
            A11 = A12;
        }
        ...
        let A13 = [
            [A11[0][0], A11[0][1], A11[0][2], A11[0][3]],
            [A11[1][0], A11[1][1], A11[1][2], A11[1][3]],
            [A11[2][0] * A11[0][2], A11[2][1] * A11[0][2], A11[2][2] * A11[0][2], A11[2][3] * A11[0][2]]
        ];
        console.log(A13)

        if (A13[0][2] - A13[2][2] != 0) {
            let A14 = [
                [A13[0][0] + A13[2][0], A13[0][1] + A13[2][1], A13[0][2] + A13[2][2], A13[0][3] + A13[2][3]],
                [A13[1][0], A13[1][1], A13[1][2], A13[1][3]],
                [A11[2][0], A11[2][1], A11[2][2], A11[2][3]]
            ];
            console.log(A14)
            A13 = A14;
        }
        ...
        //Step 3 of Jordan
        let A15 = [
            [A13[0][0], A13[0][1], A13[0][2], A13[0][3]],
            [A13[1][0] * A13[0][1], A13[1][1] * A13[0][1], A13[1][2] * A13[0][1], A13[1][3] * A13[0][1]],
            [A13[2][0], A13[2][1], A13[2][2], A13[2][3]]
        ];
        console.log(A15)

        if (A15[0][1] - A15[1][1] != 0) {
            let A16 = [
                [A15[0][0] + A15[1][0], A15[0][1] + A15[1][1], A15[0][2] + A15[1][2], A15[0][3] + A15[1][3]],
                [A11[1][0], A11[1][1], A11[1][2], A11[1][3]],
                [A11[2][0], A11[2][1], A11[2][2], A11[2][3]]
            ];
            console.log(A16);
        ...
        <div>
            ...
            <Layout style={{ marginTop: 64 }}>
                ...
                <Layout>
                    <Content id="content">
                        <div id="c2">
                            <h1 style={{ textAlign: 'center', paddingBottom: '20px', margin: 0 }}>Gauss-Jordan Method</h1>
