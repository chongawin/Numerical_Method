...
function Gauss_Seidel() {
    ...
    function componentDidMount() {
        ...
        axios.get('http://localhost:8000/data/Gauss_Seidel').then(res => {
            api = res.data;
    ...
    const handleSubmit = (e) => {
        ...
        while (a > 0 || b > 0 || c > 0) {
            ...
            x2new = A[1][3] - (A[1][0] * x1new) - (A[1][2] * x3);
            x3new = A[2][3] - (A[2][0] * x1new) - (A[2][1] * x2new);
            a = abs(x1new - x1);
            b = abs(x2new - x2);
            c = abs(x3new - x3);
            x1 = x1new;
        ...
        <div>
            ...
            <Layout style={{ marginTop: 64 }}>
                ...
                <Layout>
                    <Content id="content">
                        <div id="c2">
                            <h1 style={{ textAlign: 'center', paddingBottom: '20px', margin: 0 }}>Gauss Seidel Method</h1>
